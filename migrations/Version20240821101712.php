 ...
 */
final class Version20240821101712 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E929C1004E FOREIGN KEY (video_id) REFERENCES videos (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
